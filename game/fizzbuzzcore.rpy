...
label fizzbuzzcore:
    ...
    if isJoe:
        ...
        call postfizzbuzz(mark=mark, candidate='Joe') from _call_postfizzbuzz
    ...
    if isEmily:
        ...
        call postfizzbuzz(mark=mark, candidate='Emily') from _call_postfizzbuzz_1
...
label markAdamFizzbuzz:
    ...
    call postfizzbuzz(mark=mark, candidate='Adam') from _call_postfizzbuzz_2
